...
<h2>Service</h2>
<span><a href="index.html">home</a> / service</span>
</div>
</div>
</div>
</div>
        ...
        <div class="row">
          ...
          <div class="service_right">
            <div class="car_washing">
              <a href="#">
                <div class="service_icon round"></div>
                <h5 class="wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">Diabetes Management</h5>
              </a>
            </div>
            <div class="renovation">
              <a href="#">
                <div class="service_icon round"></div>
                <h5 class="wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">Diagnostic Procedures</h5>
              </a>
            </div>
            <div class="green_cleaning">
              <a href="#">
                <div class="service_icon round"></div>
                <h5 class="wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">Fecal Testing</h5>
              </a>
            </div>
          </div>
        </div>
