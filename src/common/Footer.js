    ...
    <div class="row">
      <div class="col-md-4">
        <div class="footer-top-info">
          <span class="footer-icons"><i class="fa fa-map-o"></i></span>
          <p>1828 Johns Drive Glenview, IL 60025</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="footer-top-info">
          <span class="footer-icons"><i class="fa fa-clock-o"></i></span>
          <p>Working Days Monday to Friday</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="footer-top-info">
          <span class="footer-icons"><i class="fa fa-headphones"></i></span>
          ...
          <div class="col-md-4 col-lg-4">
            <div class="footer-wid map-preview">
              ...
              <div class="address-info">
                ...
                <span><i class="fa  fa-envelope"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                    data-cfemail="0a797f7a7a65787e4a7a6f7e69666364636924696567">[email&#160;protected]</a> </span>
              </div>
              <div class="subscribe">
